...
class T5DenseReluDense(nn.Module):
    def __init__(self, config):
        super().__init__()
        self.wi = nn.Linear(config.hidden_size, config.adapter_size, bias=False)
...
class BertForPreTraining(BertPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from modeling.transformers import BertTokenizer, BertForPreTraining
        >>> import torch
...
class BertLMHeadModel(BertPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from modeling.transformers import BertTokenizer, BertLMHeadModel, BertConfig
        >>> import torch
...
class BertForNextSentencePrediction(BertPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs,
        ...
        ```python
        >>> from modeling.transformers import BertTokenizer, BertForNextSentencePrediction
        >>> import torch
